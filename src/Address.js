  ...
  useAnimation(ref, {scaleX: hovered ? 1.1 : 1, scaleY: hovered ? 1.1 : 1});
    return (
        <div className='address'>
            <Link to='/'>
            <img className="address__logo" src='https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Amazon_logo.svg/1024px-Amazon_logo.svg.png' alt="" />
</Link>
<div className='address__container'>
    ...
    <h5>Country</h5>      
        ...
        <Link to="/payment">
        <button type='submit'  className='address__signInButton' ref={ref} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>Use this address</button>
        </Link>
    </form>
